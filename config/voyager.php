...
//        'namespace' => 'App\\Http\\Controllers\\Voyager',
    ...
    'widgets' => [
        ...
        [
            ...
            'model' => App\ReportedUsers::class,
            'url' => 'admin/reported-users',
        ],
        [
            'name' => 'Blocked Users',
            'icon' => 'voyager-file-text',
            'model' => App\BlockedUsers::class,
            'url' => 'admin/blocked',
        ],
    ],
    /*
    ...
    'dashboard' => [
        ...
        'widgets' => [
            ...
            'App\\Widgets\\ExpertDimmer',
            'App\\Widgets\\ReportedUserDimmer',
            'App\\Widgets\\BlockedUserDimmer',
        ],
    ],
    /*
      |--------------------------------------------------------------------------
    ...
    'additional_css' => [
        'finco-assets/css/finco-styles.css',
    ],
    'additional_js' => [
        'finco-assets/js/finco-scripts.js',
    ],
];
