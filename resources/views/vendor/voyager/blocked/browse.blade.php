                                ...
                                <td>
                                    ...
                                    <div class="readmore">{{ strlen( strip_tags($data->{$row->field}, '<b><i><u>') ) > 200 ? substr(strip_tags($data->{$row->field}, '<b><i><u>'), 0, 200) . ' ...' : strip_tags($data->{$row->field}, '<b><i><u>') }}</div>
                                                                            ...
                                                                            <td class="no-sort no-click" id="bread-actions">
                                                                                ...
                                                                                <a href="{{ route('voyager.'.$dataType->slug.'.edit', $data->id) }}" title="Edit" class="btn btn-sm btn-primary edit">
                                                                                ...
                                                                                <a href="javascript:;" title="Delete" class="btn btn-sm btn-danger delete" data-id="{{ $data->id }}" id="delete-{{ $data->id }}">
                                                                                    <i class="voyager-trash"></i> <span class="hidden-xs hidden-sm">Delete</span>
                                                                                </a>
                                                                                @endif 

                                                                                <a href="javascript:;" title="Unblock" class="btn btn-sm btn-danger unblock" data-id="{{$data->id}}" style="width: 80px;display: block !important;">
                                                                                    <i class="voyager-trash"></i> <span class="hidden-xs hidden-sm">Unblock</span>
                                                                                </a>
                                                                            </td>
                                                                            </tr>
                                                                            @endforeach
                                                                                ...
                                                                                <div class="modal-dialog">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-header">
                                                                                            ...
                                                                                            <h4 class="modal-title"><i class="voyager-trash"></i> Are you sure you want to unblock
                                                                                                this {{ strtolower($dataType->display_name_singular) }}?</h4>
                                                                                        </div>
                                                                                        <div class="modal-footer">

                                                                                            <a href="/expert/block" type="button" id="blockBtn" class="btn btn-default" data-dismiss="modal">Yes Unblock this user</a>
                                                                            ...
                                                                            <script>
                                                                                ...
                                                                                @endif
                                                                                        ...
                                                                                        $('td, .unblock').on('click', '.unblock', function (e) {
                                                                                var id = $(e.target).attr('data-id');
                                                                                
                                                                                $('#blockBtn').attr('href', "user/unblock/" + id);
                                                                                $('#blockBtn').click(function(){
                                                                                window.location.href = "user/unblock/" + id;
                                                                                });
