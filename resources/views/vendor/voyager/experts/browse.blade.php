                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif($row->field == "profession_id")
                                    {{$data->profession->profession or "Invalid Profession"}}
                                    ...
                                    <div class="readmore">{{ strlen( strip_tags($data->{$row->field}, '<b><i><u>') ) > 200 ? substr(strip_tags($data->{$row->field}, '<b><i><u>'), 0, 200) . ' ...' : strip_tags($data->{$row->field}, '<b><i><u>') }}</div>
                                                                            ...
                                                                            <td class="no-sort no-click" id="bread-actions">
                                                                                ...
                                                                                <a href="javascript:;" title="Block" class="btn btn-sm btn-danger block" data-expertID="{{$data->id}}" style="width: 70px;display: block !important;">
