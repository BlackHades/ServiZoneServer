                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php elseif($row->field == "profession_id"): ?>
                                    <?php echo e(isset($data->profession->profession) ? $data->profession->profession : "Invalid Profession"); ?>
                                    ...
                                    <div class="readmore"><?php echo e(strlen( strip_tags($data->{$row->field}, '<b><i><u>') ) > 200 ? substr(strip_tags($data->{$row->field}, '<b><i><u>'), 0, 200) . ' ...' : strip_tags($data->{$row->field}, '<b><i><u>')); ?></div>
                                                                            ...
                                                                            <td class="no-sort no-click" id="bread-actions">
                                                                                ...
                                                                                <a href="<?php echo e(route('voyager.'.$dataType->slug.'.show', $data->id)); ?>" title="View" class="btn btn-sm btn-warning">
                                                                                    <i class="voyager-eye"></i> <span class="hidden-xs hidden-sm">View</span>
                                                                                </a>
                                                                                <?php endif; ?>

                                                                                <?php if(Voyager::can('edit_'.$dataType->name)): ?>
                                                                                <a href="<?php echo e(route('voyager.'.$dataType->slug.'.edit', $data->id)); ?>" title="Edit" class="btn btn-sm btn-primary edit">
                                                                                ...
                                                                                <a href="javascript:;" title="Delete" class="btn btn-sm btn-danger delete" data-id="<?php echo e($data->id); ?>" id="delete-<?php echo e($data->id); ?>">
                                                                                    <i class="voyager-trash"></i> <span class="hidden-xs hidden-sm">Delete</span>
                                                                                </a>
                                                                                <?php endif; ?> 

                                                                                <a href="javascript:;" title="Block" class="btn btn-sm btn-danger block" data-expertID="<?php echo e($data->id); ?>" style="width: 70px;display: block !important;">
                                                                                    <i class="voyager-trash"></i> <span class="hidden-xs hidden-sm">Block</span>
                                                                                </a>
                                                                            </td>
                                                                            </tr>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                                ...
                                                                                <div class="modal-dialog">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-header">
                                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                                                                                    aria-hidden="true">&times;</span></button>
                                                                                            <h4 class="modal-title"><i class="voyager-trash"></i> Are you sure you want to delete/block
                                                                                                this <?php echo e(strtolower($dataType->display_name_singular)); ?>?</h4>
                                                                                        </div>
                                                                                        <div class="modal-footer">
